...
## Part 3
This lab definetely helped me understand what getQuery.split does and the other methods that are used to create a web server. It splits the path so you can actually extract information/data and use it to put onto your website. 
